"""
execute_ct.py — CT-IR execution entry point.
...
from omnibachi.implementation.execution.machine.transforms.ct_executor import CTExecutor
...
def _get_executor() -> CTExecutor:
    ...
    if _executor is None:
        # ARCHITECTURE: structure.* imports FORBIDDEN
        # bootstrap() call removed - runtime works from snapshot ONLY
        # No dynamic path setup required
